...
for index=1:length(ca_source)
    ...
    data_directory = strcat("../../data/SingleAP_data_mot/", calcium_source, "/");
    mkdir(data_directory)
    
    MOT = 10;                           % ms    Mean open duration of the pore at 20 minutes
    n_mot_percent_incr = 100;         % average percentage increase in mean open time (MOT).         
    ...
    for time_of_recording=20:20:80      % time of recording in minutes.
        ...
        for k=35     % Interation over Number of channels ranging from 5 to 150 VGCC number
            ...
            for n=1:num_trials
                ...
                mean_open_time = MOT;                               % ms    Mean open duration of the pore at time of recording
        ...
        MOT = MOT + MOT;                                    % ms    save MOT for next iteration/time of recording        
    end
end