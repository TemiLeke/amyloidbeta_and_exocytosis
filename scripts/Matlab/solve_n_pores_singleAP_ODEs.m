...
for index=1:length(ca_source)
    ...
    data_directory = strcat("../../data/SingleAP_data_n_pores/", calcium_source, "/");
    mkdir(data_directory)
    
    num_pores = 200;                    % number of pores at 20 minutes
    n_pores_percent_incr = 100;         % average percentage increase in number of pores.         
    ...
    for time_of_recording=20:20:80      % time of recording in minutes.
        ...
        num_pores = num_pores + num_pores;  % save num_pores for next iteration/time of recording        
    end
end